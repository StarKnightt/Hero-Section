    ...
    <div className="relative h-screen w-screen overflow-x-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-20 pb-20 text-center sm:px-6 lg:px-8">
        ...
        <div ref={containerRef} className="relative mx-auto mt-16 max-w-5xl">
          <div 
            className={`absolute -top-20 -left-20 w-64 md:-left-32 transition-all duration-1000 ease-out
          ...
          <div 
            className={`absolute -top-20 -right-20 w-64 md:-right-32 transition-all duration-1000 ease-out
              ${isVisible ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 translate-x-full -translate-y-full'}
              hover:scale-105 hover:-translate-y-2`}
          ...
          <div 
            className={`absolute -bottom-20 -left-20 w-64 md:-left-32 transition-all duration-1000 ease-out
              ${isVisible ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 -translate-x-full translate-y-full'}
              hover:scale-105 hover:translate-y-2`}
          ...
          <div 
            className={`absolute -bottom-20 -right-20 w-64 md:-right-32 transition-all duration-1000 ease-out
              ${isVisible ? 'opacity-100 translate-x-0 translate-y-0' : 'opacity-0 translate-x-full translate-y-full'}
              hover:scale-105 hover:translate-y-2`}
